      ...
      case JobName.ARCHIVE_EXPIRED_MATCHES: {
        ...
        for (const conn of expiredConnections) {
          ...
          publishPromises.push(
            ...
            redisManager.userDetail.cacheConnectionList(conn.user1Id, [], ConnectionListType.ARCHIVED),
            redisManager.userDetail.cacheConnectionList(conn.user2Id, [], ConnectionListType.ARCHIVED),
          );
        }
